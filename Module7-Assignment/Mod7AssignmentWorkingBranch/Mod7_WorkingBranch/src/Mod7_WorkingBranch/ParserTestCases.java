...
public class ParserTestCases {
    ...
    public void mapSort_ReturnsValidHashMap() throws Exception {
        ...
        assertNotNull(PoemParse_Sorter_Mod7.mapSort(testMap));
    }

    @Test
    public void mapToString_FormatsString() throws Exception {
        var testMap = new HashMap<String, Integer>(mapGen());
        assertNotNull(PoemParse_Sorter_Mod7.mapToString(testMap));
    }

    @Test
    public void poemSorter_DoesSomething() throws Exception {
        assertNotNull(PoemParse_Sorter_Mod7.poemSorter(
                "Mod7_WorkingBranch\\src\\Mod7_WorkingBranch\\poem.txt"));
